      ...
      <div className="container" style={{ marginBottom: 30 }}>
        <div className="row justify-content-center align-items-center">
          <div className="col-5 border-right py-3" style={{ paddingRight: 80 }}>
            <Fade delay={300}>
              <p className="mb-4">Transfer Payment :</p>
              <p>Tax : {tax}%</p>
              <p>Sub Total: ${subTotal} USD </p>
              <p>Total Payment: ${grandTotal} USD </p>
          ...
          <div className="col-5 py-5" style={{ paddingRight: 80 }}>
            <Fade delay={600}>
              <label htmlFor="proofPayment">Upload Payment Slip</label>
              <InputFile
                accept="image/*"
                id="proofPayment"
                name="proofPayment"
              ...
              <label htmlFor="bankName">Source Bank</label>
              <InputText
                id="bankName"
                name="bankName"
                type="text"
              ...
              <label htmlFor="bankHolder">Name Sender</label>
              <InputText
                id="bankHolder"
                name="bankHolder"
                type="text"
